...
public class DealerTradeStateVisitor extends DealerMessageVisitor {

    public DealerTradeStateVisitor(MonopolyController controller, ContentManager contentManager) {
